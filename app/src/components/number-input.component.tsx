...
export default function QuantityInput(props: IProps) {
    const { onChange, value, name } = props;
  return <CustomNumberInput name={name} onChange={onChange} style={{ display: 'flex'}} required aria-label="Quantity Input" value={value} min={1} max={99} />;
}
const blue = {
    100: '#DAECFF',
    200: '#B6DAFF',
